...
```gradle
dependencies {
    implementation 'com.github.apiverve:moonrisemoonset-api:1.1.13'
}
```
...
```java
import com.apiverve.moonrisemoonset.MoonriseMoonsetAPIClient;
import com.apiverve.moonrisemoonset.APIResponse;
import com.apiverve.moonrisemoonset.APIException;

// Initialize the client
MoonriseMoonsetAPIClient client = new MoonriseMoonsetAPIClient("YOUR_API_KEY");
...
try {
    ...
    parameters.put("date", "01-16-2026");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/moonrisemoonset](https://docs.apiverve.com/ref/moonrisemoonset)
...
- **Documentation:** [https://docs.apiverve.com/ref/moonrisemoonset](https://docs.apiverve.com/ref/moonrisemoonset)
- **Issues:** [GitHub Issues](https://github.com/apiverve/moonrisemoonset-api/issues)
