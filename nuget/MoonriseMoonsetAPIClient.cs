...
namespace APIVerve.API.MoonriseMoonset
{
    ...
    /// <summary>
    /// Client for the MoonriseMoonset API
    /// </summary>
    public class MoonriseMoonsetAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/moonrisemoonset";
        ...
        {
            { "lat", new ValidationRule { Type = "number", Required = true, Min = -90, Max = 90 } },
            { "lon", new ValidationRule { Type = "number", Required = true, Min = -180, Max = 180 } },
            { "date", new ValidationRule { Type = "string", Required = false, Format = "date" } }
        };
        ...
        public MoonriseMoonsetAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MoonriseMoonsetAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MoonriseMoonsetAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MoonriseMoonsetQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MoonriseMoonsetQueryOptions options)
        {
        ...
        public ResponseObj Execute(MoonriseMoonsetQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MoonriseMoonsetQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MoonriseMoonsetQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MoonriseMoonsetQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MoonriseMoonsetQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MoonriseMoonsetQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MoonriseMoonsetQueryOptions options)
        {
