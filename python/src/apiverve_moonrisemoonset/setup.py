...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/moonrisemoonset',
        'Source': 'https://github.com/apiverve/moonrisemoonset-api',
        'Bug Tracker': 'https://github.com/apiverve/moonrisemoonset-api/issues'
    },
    classifiers=[
