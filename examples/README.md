# Moonrise Moonset API - Examples

This folder contains example code for using the Moonrise Moonset API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/moonrisemoonset',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/moonrisemoonset");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/moonrisemoonset](https://docs.apiverve.com/ref/moonrisemoonset)
